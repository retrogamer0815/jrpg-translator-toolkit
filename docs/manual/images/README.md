...
The other images in this batch are the supplied screenshots copied without modification. The screenshot models, settings, and controller bindings are examples, not a recommended or permanent default configuration.
