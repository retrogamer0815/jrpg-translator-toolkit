...
The supplied screenshots illustrate **28 of 28 topics: 26 complete, 2 partial, and none awaiting its first image**. Partial topics have published images plus a numbered placeholder for the missing companion view. No nonexistent image is embedded.
...
| S07 | Complete | [Game Text page](04-game-text-translation.md) | S07a: [game-text-page.png](images/game-text-page.png), S07b: [game-text-formatting-and-startup.png](images/game-text-formatting-and-startup.png) | S07a: original S07 AI settings and capture actions. S07b: multiple-capture help, Formatting, and Startup & advanced capture, including image-size limit. |
...
| S09 | Complete | [Audio setup and input check](05-audio-translation.md) | [audio-setup-and-input-check.png](images/audio-setup-and-input-check.png), [audio-input-check-result.png](images/audio-input-check-result.png), [audio-start-stop-control.png](images/audio-start-stop-control.png) | S09a: AI/language and playback-device selection. S09b: successful local input check and expanded troubleshooting. S09c: Live translation start control and Off status. |
| S10 | Complete | [Explanation settings](06-explanation.md) | [explanation-settings.png](images/explanation-settings.png), [explanation-saving-and-startup.png](images/explanation-saving-and-startup.png) | S10a: AI choices, Explain last text, and Open Study Library. S10b: Library, screenshot, and plain-text saving plus expanded startup options. |
...
| S14 | Complete | [Terminology overview](08-terminology-overrides.md) | [terminology-overview.png](images/terminology-overview.png), [terminology-selectors-and-local-corrections.png](images/terminology-selectors-and-local-corrections.png) | S14a: enable switch and local-correction introduction. S14b: both glossary selections and management controls, with the local-corrections manager partially covering the page and cropped on the right. |
...
| S21 | Partial | [Library dropdown and management](11-study-library.md) | [library-dropdown-and-management.png](images/library-dropdown-and-management.png), [rename-study-library.png](images/rename-study-library.png) | S21a: separated Manage Study Libraries command. S21b: Rename Study Library. **Still needed S21c:** Library manager with create, rename, archive, and restore options. |
| S22 | Complete | [Table filters and columns](11-study-library.md) | [table-filters-and-columns.png](images/table-filters-and-columns.png) | S22a: filtered result and a cropped Filters dialog. The requested companion view was removed from the checklist; the text explains column selection. |
| S23 | Complete | [Metadata and current chapter](11-study-library.md) | [metadata-and-current-chapter.png](images/metadata-and-current-chapter.png), [edit-explanation-details.png](images/edit-explanation-details.png) | S23a: future-entry Current chapter dialog. S23b: Edit explanation details for an existing saved entry, including chapter, speaker, tags, and manual Anki status. |
...
| S26 | Partial | [Recommendation preferences](11a-study-recommendations.md) | [recommendation-preferences.png](images/recommendation-preferences.png), [regenerate-recommendations.png](images/regenerate-recommendations.png) | S26a: generation confirmation with candidate counts, level/style, and Customize. S26b: regeneration confirmation and rating-replacement warning. **Still needed S26c:** customization focus areas and optional instructions. |
