...
| S21 | Complete | [Library dropdown and management](11-study-library.md) | [library-dropdown-and-management.png](images/library-dropdown-and-management.png), [manage-study-libraries.png](images/manage-study-libraries.png) | S21a: separated Manage Study Libraries command. S21b: manager with Library counts, storage, New library, Switch library, Rename, Archive, Open Folder, and Archived libraries. No additional companion view is required. |
