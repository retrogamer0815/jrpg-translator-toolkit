...
$functions = @('CPPalette', 'CPSetWindowCloaked', 'StudyLibraryImageDimensions',
    ...
    'CPSetCaptureMaxKB', 'CPMaxPngAdjustSyncValue', 'AudioSessionProcess', 'AudioSessionClear',
    'AudioProcessAlive', 'AudioProcessRelease', 'AudioProcessRecord', 'AudioSetProcess',
    'AudioLaunchProcess', 'AudioStartOwnedProcess', 'AudioCommandMatches', 'AudioProcessCommandLine', 'AudioOpenVerifiedProcess',
    ...
    'GameProfileSafeName', 'GameProfilePath', 'ListGameProfiles', 'ReadIniInt', 'GameProfileReadInt',
    ...
    'CPPromptEditorComparableText', 'CPPromptEditorConfirmClose',
...
$studyFunctions = @(
    ...
    'StudyReaderAddReviewedAnkiNote', 'StudyAnkiShowUncertainAdd', 'StudyReaderAnkiMessage', 'StudyLibraryOwnedMessage',
    ...
    'StudyCandidatesRecommendationBigBoxShow', 'StudyDialogFocusIfAlive',
